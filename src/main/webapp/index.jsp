...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            tb.load(rootPath + "/barcode/listUI.shtml");
            $("[nav-n]").each(function () {
...
<section class="vbox">
    <header class="bg-dark dk header navbar navbar-fixed-top-xs">
        <div class="navbar-header aside-md" style="width:350px">
            ...
            <img src="${ctx}/notebook/notebook_files/logo.png" class="m-r-sm">出口危险化学品及其包装溯源系统</a>
            ...
            <%--</a>--%>
                <%--<section class="dropdown-menu aside-xl on animated fadeInLeft no-borders lt">--%>
                    <%--<div class="wrapper lter m-t-n-xs">--%>
                        <%--<a href="index.html#" class="thumb pull-left m-r">--%>
                            <%--<img src="${ctx}/notebook/notebook_files/avatar.jpg" class="img-circle">--%>
                        <%--</a>--%>

                        <%--<div class="clear">--%>
                            <%--<a href="index.html#">--%>
                                <%--<span class="text-white font-bold">@MikeMcalidek</span>--%>
                            <%--</a>--%>
        ...
        <ul class="nav navbar-nav navbar-right m-n hidden-xs nav-user">
                ...
                <%--<section class="dropdown-menu aside-xl">--%>
                    <%--<section class="panel bg-white">--%>
                        <%--<header class="panel-heading b-light bg-light">--%>
                            <%--<strong>You have <span class="count" style="display: inline;">3</span> notifications--%>
                            <%--</strong>--%>
                        <%--</header>--%>
                        <%--<div class="list-group list-group-alt animated fadeInRight">--%>
                            ...
                            <%--<a href="index.html#" class="media list-group-item">--%>
                                <%--<span class="pull-left thumb-sm">--%>
                                    <%--<img src="${ctx}/notebook/notebook_files/avatar.jpg" alt="John said"--%>
                                         <%--class="img-circle">--%>
								<%--</span>--%>
								<%--<span class="media-body block m-b-none"> Use awesomeanimate.css<br>--%>
                                    <%--<small class="text-muted">10minutes ago</small>--%>
								<%--</span>--%>
                            <%--</a>--%>
                            <%--<a href="index.html#" class="media list-group-item">--%>
                        ...
                        <%--<footer class="panel-footer text-sm">--%>
                            <%--<a href="index.html#" class="pull-right">--%>
                                <%--<i class="fa fa-cog"></i>--%>
                            <%--</a>--%>
                            <%--<a href="index.html#notes" data-toggle="class:show animated fadeInRight">See all--%>
                                <%--thenotifications</a>--%>
                        <%--</footer>--%>
                    <%--</section>--%>
                <%--</section>--%>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu animated fadeInRight">
                    ...
                    <%--<li>--%>
                        <%--<a href="index.html#">--%>
                            <%--<span class="badge bg-danger pull-right">3</span> 消息提示--%>
                        <%--</a>--%>
                    <%--</li>--%>
